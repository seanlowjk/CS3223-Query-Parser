...
/** CUP v0.10k generated parser.
  * @version Sun Mar 14 13:32:52 SGT 2021
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\051\000\002\003\005\000\002\002\004\000\002\003" +
    "\006\000\002\003\003\000\002\004\003\000\002\004\005" +
    "\000\002\004\005\000\002\004\006\000\002\004\007\000" +
    "\002\004\010\000\002\005\010\000\002\005\010\000\002" +
    "\005\006\000\002\005\006\000\002\005\011\000\002\005" +
    "\011\000\002\005\007\000\002\005\007\000\002\006\005" +
    ...
    "\005\000\002\007\006\000\002\007\006\000\002\007\006" +
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\125\000\004\020\007\001\002\000\012\002\ufffd\023" +
    "\121\024\120\025\ufffd\001\002\000\006\002\ufffe\025\114" +
    ...
    "\023\uffe6\024\uffe6\025\uffe6\001\002\000\020\004\uffdb\027" +
    "\uffdb\030\uffdb\031\uffdb\032\uffdb\033\uffdb\036\uffdb\001\002" +
    "\000\014\002\uffe7\005\uffe7\023\uffe7\024\uffe7\025\uffe7\001" +
    "\002\000\020\004\uffd9\027\uffd9\030\uffd9\031\uffd9\032\uffd9" +
    "\033\uffd9\036\uffd9\001\002\000\020\004\uffde\027\uffde\030" +
    "\uffde\031\uffde\032\uffde\033\uffde\036\uffde\001\002\000\020" +
    "\004\uffda\027\uffda\030\uffda\031\uffda\032\uffda\033\uffda\036" +
    "\uffda\001\002\000\020\004\uffdd\027\uffdd\030\uffdd\031\uffdd" +
    "\032\uffdd\033\uffdd\036\uffdd\001\002\000\020\004\uffdc\027" +
    ...
    "\006\020\007\026\115\001\002\000\004\020\007\001\002" +
    "\000\004\002\001\001\002\000\004\002\uffff\001\002\000" +
    "\016\004\017\027\014\030\021\031\011\032\013\033\010" +
    "\001\002\000\016\004\017\027\014\030\021\031\011\032" +
    "\013\033\010\001\002\000\012\002\ufffc\005\025\024\123" +
    "\025\ufffc\001\002\000\016\004\017\027\014\030\021\031" +
    "\011\032\013\033\010\001\002\000\012\002\ufff9\005\025" +
    "\025\ufff9\035\125\001\002\000\006\002\ufff8\025\ufff8\001" +
    "\002\000\012\002\ufffb\005\025\025\ufffb\035\127\001\002" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\125\000\010\003\005\004\004\005\003\001\001\000" +
    ...
    "\002\001\001\000\002\001\001\000\006\006\125\007\011" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Attribute a2 = (Attribute)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 24: // condition ::= attribute op STRINGLIT 
            {
              Condition RESULT = null;
		...
		Condition c = (Condition)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 22: // conditionlist ::= conditionlist COMMA condition 
            {
              ArrayList RESULT = null;
		...
		TokenValue i = (TokenValue)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 20: // tablelist ::= tablelist COMMA ID 
            {
              ArrayList RESULT = null;
		...
		Attribute at = (Attribute)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 18: // attlist ::= attlist COMMA attribute 
            {
              ArrayList RESULT = null;
		...
		Attribute a = (Attribute)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 17: // sqlquery ::= SELECT DISTINCT STAR FROM tablelist 
            {
		...
		ArrayList t = (ArrayList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 16: // sqlquery ::= SELECT DISTINCT attlist FROM tablelist 
            {
              SQLQuery RESULT = null;
		...
		ArrayList t = (ArrayList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 15: // sqlquery ::= SELECT DISTINCT STAR FROM tablelist WHERE conditionlist 
            {
              SQLQuery RESULT = null;
		...
		ArrayList c = (ArrayList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 14: // sqlquery ::= SELECT DISTINCT attlist FROM tablelist WHERE conditionlist 
            {
              SQLQuery RESULT = null;
		...
		ArrayList c = (ArrayList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 13: // sqlquery ::= SELECT STAR FROM tablelist 
            {
              SQLQuery RESULT = null;
		int tleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).left;
		int tright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right;
		ArrayList t = (ArrayList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 12: // sqlquery ::= SELECT attlist FROM tablelist 
            {
              SQLQuery RESULT = null;
		int aleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int aright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		ArrayList t = (ArrayList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // sqlquery ::= SELECT STAR FROM tablelist WHERE conditionlist 
            {
              SQLQuery RESULT = null;
		int tleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int tright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		ArrayList c = (ArrayList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 10: // sqlquery ::= SELECT attlist FROM tablelist WHERE conditionlist 
            {
              SQLQuery RESULT = null;
		int aleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)).left;
		int aright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)).right;
		...
		ArrayList c = (ArrayList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 9: // finalquery ::= sqlquery GROUPBY attlist ORDERBY attlist DESC 
            {
              SQLQuery RESULT = null;
		...
		ArrayList a = (ArrayList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // finalquery ::= sqlquery ORDERBY attlist 
            {
              SQLQuery RESULT = null;
		...
		ArrayList a = (ArrayList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // finalquery ::= sqlquery GROUPBY attlist 
            {
              SQLQuery RESULT = null;
		int sleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int sright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		SQLQuery s = (SQLQuery)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // mainquery ::= finalquery INTERSECT ALL finalquery 
            {
              SQLQuery RESULT = null;
		int sleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).left;
		int sright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).right;
