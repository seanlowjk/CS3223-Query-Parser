...
public class QueryMain {
    ...
    public static void main(String[] args) {
        ...
        configureBufferManager(sqlquery.getNumJoin(), sqlquery.getNumOrder(), args, in);
     ...
     **/
    private static void configureBufferManager(int numJoin, int numOrder, String[] args, BufferedReader in) {
        if (numJoin != 0 || numOrder != 0) {
            int numBuff = 1000;
            if (args.length < 4) {
